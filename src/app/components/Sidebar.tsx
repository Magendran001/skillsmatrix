  ...
  return (
    ...
    >
      ...
      <div
        ...
        id="sidebar_content"
      >
        <div className="scrollable-y-hover grow shrink-0 flex ">
          <div className="menu flex flex-col grow gap-2 ">
            <div className="menu-item ">
              <div className="menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] pl-[10px] pr-[10px] py-[6px]">
                <span className={`menu-icon items-start ${pathname === "/dashboard"  ? 'text-primary' : 'text-gray-700'} dark:text-gray-400 w-[20px] `}>
                  <i className="ki-filled ki-element-11 text-lg"></i>
                </span>
                <span className={`menu-title text-sm font-semibold ${pathname === "/dashboard"  ? 'text-primary' : 'text-gray-700'} menu-item-active:text-primary menu-link-hover:!text-primary `}>
            ...
            >
              <div className="menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] pl-[10px] pr-[10px] py-[6px]">
                <span className={`menu-icon items-start ${pathname === "/publicprofile"  ? 'text-primary' : 'text-gray-700'} dark:text-gray-400 w-[20px]`}>
                  <i className="ki-filled ki-profile-circle text-lg"></i>
                </span>
                <span className={`menu-title text-sm font-semibold ${pathname === "/publicprofile"  ? 'text-primary' : 'text-gray-700'} menu-item-active:text-primary menu-link-hover:!text-primary `}>
                 
                  <Link href={"/publicprofile"}>  Public Profile</Link>
                </span>
              </div>
            </div>
            <div
            ...
            >
              <div className="menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] pl-[10px] pr-[10px] py-[6px]">
              <span className={`menu-icon items-start ${pathname === "/my-account"  ? 'text-primary' : 'text-gray-700'} dark:text-gray-400 w-[20px]`}>
                  <i className="ki-filled ki-setting-2 text-lg"></i>
                </span>
                <span className={`menu-title text-sm font-semibold ${pathname === "/my-account"  ? 'text-primary' : 'text-gray-700'} menu-item-active:text-primary menu-link-hover:!text-primary `}>
